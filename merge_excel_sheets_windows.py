...
file_path = r"C:\Users\txvance\Documents\PSPS"
file_path_raw = r"C:\Users\txvance\Documents\PSPS/OpsTracker_Raw_Files"
...
# PC Format
f_sites = pd.read_excel("C:/Users/txvance/Documents/PSPS/OpsTracker_Raw_Files/opstracker_sites.xlsx", usecols=['SITE_NAME','ADDRESS','CITY','COUNTY','PSLC','POWER_METER', 'GEN_PORTABLE_PLUG', 'GEN_PORTABLE_PLUG_TYPE', 'GO95_FIRE_ZONE_SECTOR', 'SITE_STATUS', 'IS_HUB','IS_HUB_MICROWAVE','REMOTE_MONITORING','SITETECH_NAME','SITEMGR_NAME', 'POWER_COMPANY'])
f_gens = pd.read_excel("C:/Users/txvance/Documents/PSPS/OpsTracker_Raw_Files/opstracker_generators.xlsx", usecols=['PSLC', 'GEN_STATUS', 'SERIALNUM', 'FUEL_TANK1', 'FUEL_TYPE1', 'MANUFACTURER', 'MODEL', 'GEN_SIZE'])
# Macbook format
...
f_cells = pd.read_excel("C:/Users/txvance/Documents/PSPS/OpsTracker_Raw_Files/NorCal_CellInfo.xlsx", usecols=['PSLC', 'eNodeB'])
f_cells5g = pd.read_excel("C:/Users/txvance/Documents/PSPS/OpsTracker_Raw_Files/norcal_cell_info_5g.xlsx", usecols=['PSLC', 'GNODEB'])
...
f_pgemaster = pd.read_excel("C:/Users/txvance/Documents/PSPS/OpsTracker_Raw_Files/PGE_MASTER_LIST.xlsx", usecols=['PGE_BADGE_NUMBER', 'VLOOKUP($A1,[PSPS_MAIN.xlsx]PSPS_MAIN!A:A,1,FALSE)'])
...
f_ngmaster = pd.read_excel("C:/Users/txvance/Documents/PSPS/OpsTracker_Raw_Files/NAT_GAS_MASTER_LIST.xlsx", usecols=['PSLC', 'VLOOKUP($A1,[PSPS_MAIN.xlsx]PSPS_MAIN!E:E,1,FALSE)'])
# Update Rotating Block list with new sheet sent from PGE acct manager John Storm
f_pge_outage_block = pd.read_excel("C:/Users/txvance/Documents/PSPS/OpsTracker_Raw_Files/Verizon Wireless Rotating Outage Block Reference List.xlsx", usecols=['Meter #', 'Rotating Outage Block Code'])
...
f_3rdpartymaster = pd.read_excel("C:/Users/txvance/Documents/PSPS/OpsTracker_Raw_Files/3RD_PARTY_MASTER_LIST.xlsx", usecols=['PSLC', '3RD PARTY'])
...
f_vzb = pd.read_excel("C:/Users/txvance/Documents/PSPS/OpsTracker_Raw_Files/PSPS_VZB_Sites.xlsx")
f_unmatched = pd.read_excel("C:/Users/txvance/Documents/PSPS/OpsTracker_Raw_Files/PSPS_PGE_unmatched_Sites.xlsx", usecols=['POWER METER','PSPS PROB', 'PSLC','SITE NAME','ADDRESS','CITY','COUNTY', 'GEN Y/N', 'PLUG Y/N', 'PLUG TYPE', 'FUEL TYPE', 'RM Y/N', 'M/W HUB Y/N', 'HUB Y/N', 'FIELD ENGINEER', 'OPS MANAGER', 'POWER COMPANY'])
f_engie = pd.read_excel("C:/Users/txvance/Documents/PSPS/OpsTracker_Raw_Files/PSPS_Engie_unmatched_Sites.xlsx")
...
writer = pd.ExcelWriter('C:/Users/txvance/Documents/PSPS/Tracker/PSPS_MAIN.xlsx', engine='xlsxwriter')
...
# establish the xlsxwriter functionality, defining "writer" as the variable for the workbook filename
writer_sp = pd.ExcelWriter('C:/Users/txvance/Documents/PSPS/Tracker/PSPS_MAIN_SP.xlsx', engine='xlsxwriter')
# Create the merged sheet and output to the file name based on the writer variable
